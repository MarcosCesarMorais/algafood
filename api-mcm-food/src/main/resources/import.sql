...
insert into tb_cozinha (id,nome) values (3,'Brasileira');
insert into tb_cozinha (id,nome) values (4,'Mexicana');
insert into tb_cozinha (id,nome) values (5,'Italiana');
insert into tb_cozinha (id,nome) values (6,'Chinesa');
insert into tb_cozinha (id,nome) values (7,'Peruana');
insert into tb_cozinha (id,nome) values (8,'Colombiana');
insert into tb_cozinha (id,nome) values (9,'Equatoriana');
insert into tb_cozinha (id,nome) values (10,'Argentina');

insert into tb_restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao) values (1, 'Thai Gourmet', 10, 1, utc_timestamp, utc_timestamp);
...
insert into tb_estado (id,nome) values (1,"Paraná");
insert into tb_estado (id,nome) values (2,"Ceará");
insert into tb_estado (id,nome) values (3,"Minas Gerais");
insert into tb_estado (id,nome) values (4,"Bahia");

insert into tb_cidade (id, nome, estado_id) values (1, "Curitiba", 1);
insert into tb_cidade (id, nome, estado_id) values (2, "São José dos Pinhais", 1);
insert into tb_cidade (id, nome, estado_id) values (3, "Pinhais", 1);
insert into tb_cidade (id, nome, estado_id) values (4, "Colombo", 1);
insert into tb_cidade (id, nome, estado_id) values (5, "Araucária", 1);
insert into tb_cidade (id, nome, estado_id) values (6, "Fortaleza", 2);
insert into tb_cidade (id, nome, estado_id) values (7, "Acaraú", 2);
insert into tb_cidade (id, nome, estado_id) values (8, "Diamantina", 3);
insert into tb_cidade (id, nome, estado_id) values (9,"Salvador", 4);
insert into tb_cidade (id, nome, estado_id) values (10, "Porto Seguro", 4);
insert into tb_cidade (id, nome, estado_id) values (11, "Jacobina", 4);
insert into tb_cidade (id, nome, estado_id) values (12, "Juazeiro", 4);
